# LDOlab — Interactive LDO Circuit Simulator
...
The app will be deployed to GitHub Pages when you push to `main`.

## Architecture

- **Frontend**: React + Recharts (plotting) + Lucide (icons)
- **Backend**: Pyodide (Python 3 in WASM) running in a Web Worker
- **Styling**: Vanilla CSS (no Tailwind), Neo-Brutalist dark theme
...
Same as parent repo ([LICENSE](../LICENSE))

## Contributing

Feedback, bug reports, and PRs are welcome. Please open an issue or PR on GitHub.
